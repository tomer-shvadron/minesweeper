...
export const TopBar = ({ compact = false }: TopBarProps) => {
  ...
  return (
    <nav
      className="fixed top-0 right-0 left-0 z-50 flex items-center justify-between border-b border-[var(--color-border)] bg-[var(--color-glass-bg,var(--color-surface))] backdrop-blur-xl"
      style={{ height }}
